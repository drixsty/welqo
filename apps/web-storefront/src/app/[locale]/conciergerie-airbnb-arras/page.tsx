...
export async function generateMetadata({
  ...
  return {
    title: fr
      ? "Conciergerie Airbnb Arras — Gestion Locative Premium | Welqo"
      : "Arras Airbnb Concierge — Premium Property Management | Welqo",
    description: fr
      ? "Maximisez vos revenus locatifs à Arras (Grand-Place, Ronville, Saint-Nicolas). Conciergerie Airbnb complète, ménage 5★ et pricing dynamique calé sur le tourisme mémoriel et le marché de Noël. Devis gratuit."
      : "Maximize your rental income in Arras (Grand-Place, Ronville, Saint-Nicolas). Full Airbnb concierge, 5★ cleaning and dynamic pricing synced with memorial tourism and Christmas market. Free quote.",
    keywords: fr
      ? [
          "conciergerie airbnb arras",
          "gestion locative arras",
          "conciergerie arras",
          "gestion airbnb arras",
          "airbnb arras grand-place",
          "location courte durée arras",
          "gestionnaire airbnb arras",
        ]
      : [
          "airbnb concierge arras",
          "property management arras",
          "arras airbnb manager",
          "arras short term rental",
        ],
    alternates: {
      canonical:
        locale === "fr"
          ? `${BASE_URL}/conciergerie-airbnb-arras`
          : `${BASE_URL}/${locale}/conciergerie-airbnb-arras`,
      languages: {
        fr: `${BASE_URL}/conciergerie-airbnb-arras`,
        en: `${BASE_URL}/en/conciergerie-airbnb-arras`,
        "x-default": `${BASE_URL}/conciergerie-airbnb-arras`,
      },
    },
    openGraph: {
      title: fr
        ? "Conciergerie Airbnb Arras — Welqo"
        : "Arras Airbnb Concierge — Welqo",
      description: fr
        ? "Gestion locative d'exception à Arras et ses environs. Profitez de nos services de conciergerie Airbnb clé en main."
        : "Exceptional rental management in Arras and surroundings. Enjoy our turnkey Airbnb concierge services.",
      url:
        locale === "fr"
          ? `${BASE_URL}/conciergerie-airbnb-arras`
          : `${BASE_URL}/${locale}/conciergerie-airbnb-arras`,
...
export default async function ArrasLandingPage({
  params: { locale },
}: {
  params: { locale: string };
}) {
  const t = await getTranslations({ locale, namespace: "ArrasLandingPage" });
  ...
  const localBusinessSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "@id": `${BASE_URL}/#business-arras`,
    name: "Welqo Conciergerie Arras",
    description:
      locale === "en"
        ? "Premium Airbnb concierge and property management services in Arras."
        : "Services premium de conciergerie Airbnb et de gestion locative à Arras.",
    url: `${BASE_URL}/conciergerie-airbnb-arras`,
    ...
    hasMap: "https://www.google.com/maps/search/Welqo+Conciergerie+Arras",
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 2,
        name: locale === "en" ? "Arras Airbnb Concierge" : "Conciergerie Airbnb Arras",
        item: locale === "fr" ? `${BASE_URL}/conciergerie-airbnb-arras` : `${BASE_URL}/${locale}/conciergerie-airbnb-arras`,
      },
    ],
  };
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tighter mt-4">
              {locale === "en"
                ? "Estimate your Arras property potential"
                : "Estimez le rendement de votre bien à Arras"}
            </h2>
          </div>
      ...
      <section className="py-16 px-6 bg-slate-50 dark:bg-slate-900/30 border-t border-slate-100 dark:border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-2xl font-bold tracking-tighter text-slate-900 dark:text-white text-center mb-8">
            {locale === "en" ? "Useful resources on Arras Airbnb" : "Ressources utiles sur l'Airbnb à Arras"}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
            {[
              {
                title: locale === "en" ? "How Much Does an Airbnb in Arras Earn in 2025?" : "Combien rapporte un Airbnb à Arras en 2025 ?",
                href: locale === "fr" ? "/blog/combien-rapporte-airbnb-arras-2025" : "/en/blog/combien-rapporte-airbnb-arras-2025",
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tighter text-white mb-6 leading-none">
            {locale === "en"
              ? "Ready to maximize your income in Arras?"
              : "Prêt à maximiser vos revenus locatifs à Arras ?"}
          </h2>
          <p className="text-slate-400 font-medium max-w-xl mx-auto mb-10 text-base leading-relaxed">
            {locale === "en"
              ? "Schedule a free audit with our local Arras team."
              : "Organisez un audit de rendement gratuit avec notre équipe locale arrageoise."}
          </p>
