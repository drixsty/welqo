...
export async function generateMetadata({
  ...
  return {
    title: fr
      ? "Conciergerie Airbnb Béthune — Gestion Locative | Welqo"
      : "Béthune Airbnb Concierge — Property Management | Welqo",
    description: fr
      ? "Maximisez vos revenus locatifs à Béthune (Centre-Ville, Bruay-la-Buissière, Noeux-les-Mines). Conciergerie Airbnb complète, ménage 5★ et pricing dynamique. Devis gratuit."
      : "Maximize your rental income in Béthune (City Centre, Bruay-la-Buissière, Noeux-les-Mines). Full Airbnb concierge, 5★ cleaning and dynamic pricing. Free quote.",
    keywords: fr
      ? [
          "conciergerie airbnb béthune",
          "gestion locative béthune",
          "conciergerie béthune",
          "gestion airbnb béthune",
          "location courte durée béthune",
          "gestionnaire airbnb béthune",
          "airbnb bruay-la-buissière",
        ]
      : [
          "airbnb concierge bethune",
          "property management bethune",
          "bethune airbnb manager",
    ...
    alternates: {
      ...
      languages: {
        fr: `${BASE_URL}/conciergerie-airbnb-bethune`,
        en: `${BASE_URL}/en/conciergerie-airbnb-bethune`,
        "x-default": `${BASE_URL}/conciergerie-airbnb-bethune`,
      },
    },
    openGraph: {
      title: fr
        ? "Conciergerie Airbnb Béthune — Welqo"
        : "Béthune Airbnb Concierge — Welqo",
      description: fr
        ? "Gestion locative d'exception à Béthune et l'Artois. Profitez de nos services de conciergerie Airbnb clé en main."
        : "Exceptional rental management in Béthune and Artois. Enjoy our turnkey Airbnb concierge services.",
      url:
        locale === "fr"
          ? `${BASE_URL}/conciergerie-airbnb-bethune`
          : `${BASE_URL}/${locale}/conciergerie-airbnb-bethune`,
...
export default async function BethuneLandingPage({
  params: { locale },
}: {
  params: { locale: string };
}) {
  const t = await getTranslations({ locale, namespace: "BethuneLandingPage" });
  ...
  const localBusinessSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "@id": `${BASE_URL}/#business-bethune`,
    name: "Welqo Conciergerie Béthune",
    description:
      locale === "en"
        ? "Premium Airbnb concierge and property management services in Béthune and Artois."
        : "Services premium de conciergerie Airbnb et de gestion locative à Béthune et dans l'Artois.",
    url: `${BASE_URL}/conciergerie-airbnb-bethune`,
    ...
    hasMap: "https://www.google.com/maps/search/Welqo+Conciergerie+Bethune",
  };
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tighter mt-4">
              {locale === "en"
                ? "Estimate your Béthune property potential"
                : "Estimez le rendement de votre bien à Béthune"}
            </h2>
          </div>
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tighter text-white mb-6 leading-none">
            {locale === "en"
              ? "Ready to maximize your income in Béthune?"
              : "Prêt à maximiser vos revenus locatifs à Béthune ?"}
          </h2>
          <p className="text-slate-400 font-medium max-w-xl mx-auto mb-10 text-base leading-relaxed">
            {locale === "en"
              ? "Schedule a free audit with our local Béthune team."
              : "Organisez un audit de rendement gratuit avec notre équipe locale béthunoise."}
          </p>
