...
export async function generateMetadata({
  ...
  return {
    title: fr
      ? "Conciergerie Airbnb Douai — Gestion Locative Beffroi & Gayant | Welqo"
      : "Douai Airbnb Concierge — Belfry & Gayant Property Management | Welqo",
    description: fr
      ? "Maximisez vos revenus locatifs à Douai (Centre-Ville, Scarpe, Faubourg d'Arras). Conciergerie Airbnb complète, ménage 5★ et pricing dynamique calé sur le festival de Gayant et le beffroi UNESCO. Devis gratuit."
      : "Maximize your rental income in Douai (City Centre, Scarpe, Faubourg d'Arras). Full Airbnb concierge, 5★ cleaning and dynamic pricing synced with the Gayant festival and UNESCO belfry. Free quote.",
    keywords: fr
      ? [
          "conciergerie airbnb douai",
          "gestion locative douai",
          "conciergerie douai",
          "gestion airbnb douai",
          "airbnb douai beffroi",
          "location courte durée douai",
          "gestionnaire airbnb douai",
        ]
      : [
          "airbnb concierge douai",
          "property management douai",
          "douai airbnb manager",
          "douai short term rental",
        ],
    alternates: {
      canonical:
        locale === "fr"
      ...
      languages: {
        fr: `${BASE_URL}/conciergerie-airbnb-douai`,
        en: `${BASE_URL}/en/conciergerie-airbnb-douai`,
        "x-default": `${BASE_URL}/conciergerie-airbnb-douai`,
      },
    },
    openGraph: {
      title: fr
        ? "Conciergerie Airbnb Douai — Welqo"
        : "Douai Airbnb Concierge — Welqo",
      description: fr
        ? "Gestion locative d'exception à Douai et ses environs. Profitez de nos services de conciergerie Airbnb clé en main."
        : "Exceptional rental management in Douai and surroundings. Enjoy our turnkey Airbnb concierge services.",
      url:
        locale === "fr"
          ? `${BASE_URL}/conciergerie-airbnb-douai`
          : `${BASE_URL}/${locale}/conciergerie-airbnb-douai`,
...
export default async function DouaiLandingPage({
  params: { locale },
}: {
  params: { locale: string };
}) {
  const t = await getTranslations({ locale, namespace: "DouaiLandingPage" });
  ...
  const localBusinessSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "@id": `${BASE_URL}/#business-douai`,
    name: "Welqo Conciergerie Douai",
    description:
      locale === "en"
        ? "Premium Airbnb concierge and property management services in Douai."
        : "Services premium de conciergerie Airbnb et de gestion locative à Douai.",
    url: `${BASE_URL}/conciergerie-airbnb-douai`,
    ...
    hasMap: "https://www.google.com/maps/search/Welqo+Conciergerie+Douai",
  };
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tighter mt-4">
              {locale === "en"
                ? "Estimate your Douai property potential"
                : "Estimez le rendement de votre bien à Douai"}
            </h2>
          </div>
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tighter text-white mb-6 leading-none">
            {locale === "en"
              ? "Ready to maximize your income in Douai?"
              : "Prêt à maximiser vos revenus locatifs à Douai ?"}
          </h2>
          <p className="text-slate-400 font-medium max-w-xl mx-auto mb-10 text-base leading-relaxed">
            {locale === "en"
              ? "Schedule a free audit with our local Douai team."
              : "Organisez un audit de rendement gratuit avec notre équipe locale douaisienne."}
          </p>
