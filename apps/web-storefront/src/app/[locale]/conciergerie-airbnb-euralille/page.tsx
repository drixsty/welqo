    ...
    openGraph: {
      ...
      url:
        locale === "fr"
          ...
          : `${BASE_URL}/${locale}/conciergerie-airbnb-euralille`,
      type: "website",
      images: [{ url: `${BASE_URL}/og-image.jpg`, width: 1200, height: 630, alt: "Conciergerie Airbnb Euralille — Welqo" }],
    },
  };
}
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: locale === "en" ? "Euralille Airbnb Concierge" : "Conciergerie Airbnb Euralille",
        item:
          locale === "fr"
            ? `${BASE_URL}/conciergerie-airbnb-euralille`
            : `${BASE_URL}/${locale}/conciergerie-airbnb-euralille`,
