...
export async function generateMetadata({
  ...
  return {
    title: fr
      ? "Conciergerie Airbnb Vieux-Lille — Gestion Locative Premium | Welqo"
      : "Vieux-Lille Airbnb Concierge — Premium Property Management | Welqo",
    description: fr
      ? "Maximisez vos revenus Airbnb dans le Vieux-Lille. Gestion complète : ménage 5★, pricing dynamique, accueil voyageurs. Devis gratuit sous 24h."
      : "Maximise your Airbnb revenue in Vieux-Lille. Full management: 5★ cleaning, dynamic pricing, guest reception. Free quote within 24h.",
    keywords: fr
      ? [
          "conciergerie airbnb vieux-lille",
          "gestion locative vieux-lille",
          "airbnb vieux-lille",
          "location courte durée vieux-lille",
          "conciergerie airbnb lille",
        ]
      : [
          "airbnb concierge vieux-lille",
          "property management vieux-lille",
          "vieux-lille airbnb management",
        ],
    alternates: {
      canonical:
        locale === "fr"
          ? `${BASE_URL}/conciergerie-airbnb-vieux-lille`
          : `${BASE_URL}/${locale}/conciergerie-airbnb-vieux-lille`,
      languages: {
        fr: `${BASE_URL}/conciergerie-airbnb-vieux-lille`,
        en: `${BASE_URL}/en/conciergerie-airbnb-vieux-lille`,
        "x-default": `${BASE_URL}/conciergerie-airbnb-vieux-lille`,
      },
    },
    openGraph: {
      title: fr
        ? "Conciergerie Airbnb Vieux-Lille — Welqo"
        : "Vieux-Lille Airbnb Concierge — Welqo",
      description: fr
        ? "Gestion locative premium dans le Vieux-Lille. Conciergerie clé en main par Welqo."
        : "Premium rental management in Vieux-Lille. Turnkey concierge by Welqo.",
      url:
        locale === "fr"
          ? `${BASE_URL}/conciergerie-airbnb-vieux-lille`
          : `${BASE_URL}/${locale}/conciergerie-airbnb-vieux-lille`,
      type: "website",
      images: [{ url: `${BASE_URL}/og-image.jpg`, width: 1200, height: 630, alt: "Conciergerie Airbnb Vieux-Lille — Welqo" }],
    },
  };
}

export default async function VieuxLilleLandingPage({
  params: { locale },
}: {
  params: { locale: string };
}) {
  const t = await getTranslations({
    locale,
    namespace: "VieuxLilleLandingPage",
  });
  ...
  const localBusinessSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "@id": `${BASE_URL}/#business-vieux-lille`,
    name: "Welqo Conciergerie Vieux-Lille",
    description:
      locale === "en"
        ? "Premium Airbnb concierge and property management services in Vieux-Lille."
        : "Services premium de conciergerie Airbnb et de gestion locative dans le Vieux-Lille.",
    url: `${BASE_URL}/conciergerie-airbnb-vieux-lille`,
    ...
    hasMap: "https://www.google.com/maps/search/Welqo+Conciergerie+Vieux-Lille",
    parentOrganization: {
      "@type": "Organization",
      name: "Welqo",
      url: BASE_URL,
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: locale === "en" ? "Vieux-Lille Airbnb Concierge" : "Conciergerie Airbnb Vieux-Lille",
        item:
          locale === "fr"
            ? `${BASE_URL}/conciergerie-airbnb-vieux-lille`
            : `${BASE_URL}/${locale}/conciergerie-airbnb-vieux-lille`,
      ...
      <section className="relative py-28 md:py-36 px-6 bg-slate-950 overflow-hidden border-b border-white/5">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <nav className="flex items-center justify-center gap-2 text-[10px] font-bold text-white/50 mb-6 tracking-wider">
            ...
            <span className="text-white/30">Vieux-Lille</span>
          </nav>
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tighter mt-4">
              {locale === "en"
                ? "Estimate your Vieux-Lille property potential"
                : "Estimez le rendement de votre bien dans le Vieux-Lille"}
            </h2>
          </div>
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tighter text-white mb-6 leading-none">
            {locale === "en"
              ? "Ready to maximize your income in Vieux-Lille?"
              : "Prêt à maximiser vos revenus dans le Vieux-Lille ?"}
          </h2>
