...
export async function generateMetadata({
  ...
  return {
    title: fr
      ? "Conciergerie Airbnb Wazemmes — Gestion Locative Lille | Welqo"
      : "Wazemmes Airbnb Concierge — Lille Property Management | Welqo",
    description: fr
      ? "Maximisez vos revenus Airbnb à Wazemmes (Lille). Marché dominical, CHR, vie de quartier : forte demande locative. Devis gratuit sous 24h."
      : "Maximise your Airbnb revenue in Wazemmes (Lille). Sunday market, CHR hospital, neighbourhood life: strong rental demand. Free quote within 24h.",
    keywords: fr
      ? [
          "conciergerie airbnb wazemmes",
          "gestion locative wazemmes",
          "airbnb wazemmes lille",
          "location courte durée wazemmes",
          "conciergerie airbnb lille",
        ]
      : [
          "airbnb concierge wazemmes",
          "property management wazemmes lille",
          "wazemmes airbnb management",
        ],
    alternates: {
      canonical:
        locale === "fr"
      ...
      languages: {
        fr: `${BASE_URL}/conciergerie-airbnb-wazemmes`,
        en: `${BASE_URL}/en/conciergerie-airbnb-wazemmes`,
        "x-default": `${BASE_URL}/conciergerie-airbnb-wazemmes`,
      },
    },
    openGraph: {
      title: fr
        ? "Conciergerie Airbnb Wazemmes — Welqo"
        : "Wazemmes Airbnb Concierge — Welqo",
      description: fr
        ? "Gestion locative clé en main à Wazemmes. Welqo maximise vos revenus Airbnb à Lille."
        : "Turnkey rental management in Wazemmes. Welqo maximises your Airbnb revenue in Lille.",
      url:
        locale === "fr"
          ? `${BASE_URL}/conciergerie-airbnb-wazemmes`
          : `${BASE_URL}/${locale}/conciergerie-airbnb-wazemmes`,
...
export default async function WazemmeesLandingPage({
  params: { locale },
}: {
  params: { locale: string };
}) {
  const t = await getTranslations({
    locale,
    namespace: "WazemmeesLandingPage",
  });
  ...
  const localBusinessSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "@id": `${BASE_URL}/#business-wazemmes`,
    name: "Welqo Conciergerie Wazemmes",
    description:
      locale === "en"
        ? "Premium Airbnb concierge and property management services in Wazemmes, Lille."
        : "Services premium de conciergerie Airbnb et de gestion locative à Wazemmes, Lille.",
    url: `${BASE_URL}/conciergerie-airbnb-wazemmes`,
    telephone: "+33999912173",
    address: {
      "@type": "PostalAddress",
      streetAddress: "Wazemmes",
    ...
    hasMap: "https://www.google.com/maps/search/Welqo+Conciergerie+Wazemmes",
    parentOrganization: {
      "@type": "Organization",
      name: "Welqo",
      url: BASE_URL,
      ...
      <section className="relative py-28 md:py-36 px-6 bg-slate-950 overflow-hidden border-b border-white/5">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <nav className="flex items-center justify-center gap-2 text-[10px] font-bold text-white/50 mb-6 tracking-wider">
            ...
            <span className="text-white/30">Wazemmes</span>
          </nav>
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tighter mt-4">
              {locale === "en"
                ? "Estimate your Wazemmes property potential"
                : "Estimez le rendement de votre bien à Wazemmes"}
            </h2>
          </div>
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tighter text-white mb-6 leading-none">
            {locale === "en"
              ? "Ready to maximize your income in Wazemmes?"
              : "Prêt à maximiser vos revenus à Wazemmes ?"}
          </h2>
