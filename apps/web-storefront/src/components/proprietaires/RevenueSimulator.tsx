...
export function RevenueSimulator({ locale = "fr" }: { locale?: string }) {
  ...
  return (
    <div id="simulator" className="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-white/10 shadow-sm overflow-hidden">
      {/* Header */}
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <h3 className="text-white text-lg font-bold tracking-tight">
              Estimation de revenus <span className="text-primary">Hauts-de-France</span>
            </h3>
          </div>
          <div className="hidden sm:block text-right">
            <span className="text-slate-500 text-[10px] font-medium italic">Mise à jour : Avril 2026</span>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr,1.1fr] gap-6 lg:gap-10">
          ...
          <div className="space-y-5">
            <div className="space-y-2.5">
              <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 tracking-wider">Localisation</label>
            ...
            <div className="space-y-2.5">
              <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 tracking-wider">Typologie du bien</label>
            ...
            <div className="pt-2">
              <div className="bg-slate-50 dark:bg-slate-950/50 p-4 rounded-lg border border-slate-100 dark:border-slate-800/50">
                <div className="flex justify-between items-end mb-2">
                  <span className="text-[10px] font-bold text-slate-500 tracking-wider">Surface estimée</span>
                  <span className="text-sm font-bold text-slate-900 dark:text-white">{surface} m²</span>
                </div>
                <input 
                  type="range"
                  min="10"
          ...
          <div className="flex flex-col h-full">
            <div className="flex-grow space-y-3">
              ...
              <div className="px-4 py-3 bg-slate-50 dark:bg-slate-950/50 rounded-lg border border-slate-100 dark:border-slate-800 flex justify-between items-center opacity-80">
                <div>
                  <p className="text-[9px] font-bold text-slate-500 tracking-wider mb-0.5">Gestion en solo</p>
                  <p className="text-xl font-bold text-slate-500 tracking-tighter">{fmt(revenuSolo)}€ <span className="text-[10px] font-medium">/ mois</span></p>
                </div>
                <div className="text-[10px] text-slate-400 font-medium">Standard</div>
              </div>
              ...
              <div className="px-5 py-4 bg-slate-900 text-white rounded-lg border border-primary/40 relative overflow-hidden shadow-lg shadow-primary/10">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-2 mb-1.5">
                    <p className="text-[10px] font-bold text-primary tracking-widest">Welqo management</p>
                    <span className="text-[9px] font-black bg-primary text-white px-1.5 py-0.5 rounded shadow-sm">+{gainPct}%</span>
                  </div>
                  <p className="text-3xl font-bold tracking-tighter">{fmt(revenuWelqo)}€ <span className="text-xs text-slate-400 font-medium">/ mois</span></p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 py-1">
                <div className="p-3 bg-emerald-500/5 border border-emerald-500/10 rounded-lg text-center">
                  <p className="text-sm font-bold text-emerald-500">+{fmt(gain)}€</p>
                  <p className="text-[8px] text-slate-500 font-bold tracking-tighter">Gain mensuel net</p>
                </div>
                <div className="p-3 bg-primary/5 border border-primary/10 rounded-lg text-center">
                  ...
                  <p className="text-[8px] text-slate-500 font-bold tracking-tighter">Potentiel annuel</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-4">
              ...
              >
                {isFr ? `Sécuriser mes ${fmt(revenuWelqo)}€` : `Secure my ${fmt(revenuWelqo)}€`}
